...
##### FROM FILES
kickstarter_dataset_path = "s3://unimib-raw-data-2020/ds_projects_summary_raw.csv"
...
## READ TAGS DATASET
img_dataset_path = "s3://unimib-raw-data-2020/ds_img_details.csv"
...
projects_dataset_agg.write.option("compression", "snappy").mode("overwrite").parquet("s3://unimib-dwh-2020/projects_dataset.out")